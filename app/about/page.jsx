          ...
          <div className="space-y-10 mb-12">
            <section>
              ...
              <p className="text-[0.95rem] text-[#4A4540] leading-[1.8]">
                <strong className="text-[#1C1F1A] font-medium">ChatterlyAI</strong> is an AI chat project created by students for learning and educational demonstration purposes. It is not intended as a commercial product.
              </p>
            </section>
